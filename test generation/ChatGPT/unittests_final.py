...
class TestCalculateExpression(unittest.TestCase):
    ...
    def test_invalid_operation(self):
        self.assertEqual(calculate_expression("Скільки буде 10 відняти 20 поділити на?"), 'Неправильний вираз!')

    def test_worded_numbers(self):
    ...
    def test_case_insensitivity(self):
        self.assertEqual(calculate_expression("Скільки буде БУДЕ 10 додати 5?"), 15)
